...
const theme = {
  ...
  'primary-color-rgb': primaryColorRgb, // primary color for all components
  'primary-hbr': primaryHover, // primary Hover color for all components
  'secondary-color': secondaryColor, // secondary color for all components
  'secondary-hbr': secondaryHover, // secondary Hover color for all components
  'link-color': linkColor, // link color
  'link-hover': linkHover, // link Hover color
  'success-color': successColor, // success state color
  'success-hbr': successHover, // success Hover state color
