...
const SafeZoomableGroup = ZoomableGroup as unknown as React.ComponentType<any>;
const SafeComposableMap = ComposableMap as unknown as React.ComponentType<any>;
const SafeGeographies = Geographies as unknown as React.ComponentType<any>;
const SafeGeography = Geography as unknown as React.ComponentType<any>;
                ...
                <Row>
                    ...
                    <Col xxl={12} md={11} xs={24} className="px-[25px]">
                        <div className="min-ssm:h-full h-[250px] overflow-hidden">
                            ...
                            >
                                <SafeZoomableGroup zoom={position.zoom} center={[position.coordinates[0], position.coordinates[1]]} onMoveEnd={handleMoveEnd}>
                                    <SafeGeographies geography={geoUrl}>
